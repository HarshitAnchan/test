...
import GenerateAITemplate from "../../workspace/_components/GenerateAITemplate";
  ...
  const handleGenerateAIOutput = (output: any) => {
    if (ref.current) {
      ref.current
        .render(output)
        .then(() => {
          toast("AI Template Applied Successfully!");
        })
        .catch((error) => {
          console.log("Applying template failed: ", error);
        });
    }
  };
